...
export class PostsComponent implements OnInit {
  ...
  constructor(public userService:UserService, private router:Router, private storage:AngularFireStorage, private snackbar:MatSnackBar, private postService:PostService){}
